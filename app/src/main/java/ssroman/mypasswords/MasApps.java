...
public class MasApps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton areas = (ImageButton)findViewById(R.id.BTN_Areas);
        areas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=ssroman.area_y_perimetro")));
            }
        });

        ImageButton calculadora = (ImageButton)findViewById(R.id.BTN_Calculadora);
        calculadora.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=ssroman.calculadoraapp")));
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.contacto:
                ...
                break;
            case R.id.masapps:
                startActivity(new Intent(MasApps.this, MasApps.class));
                break;
            case R.id.acerca:
